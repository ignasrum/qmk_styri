...
[BASE] = LAYOUT(
    ...
    KC_LCTL,  KC_NO,  KC_DEL,  KC_LEFT,  KC_RGHT,                                                  KC_UP,  KC_DOWN,  KC_LBRC,  KC_RBRC,  KC_RCTL,
                                                    KC_LALT,   KC_LGUI,        KC_PGUP,  KC_RALT,
                                                               KC_HOME,        KC_PGDN,
                                         KC_SPACE,  KC_LCTL,   KC_END,         MO(ND),   KC_ENT,   KC_BSPC
    ),
/* Keymap ND: Second layer
 *
 * ,--------------------------------------------------.           ,--------------------------------------------------.
